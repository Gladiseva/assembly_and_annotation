...
MAKER_OUTPUT="/data/users/lgladiseva/annotation_course/gene_annotation"
...
perl /data/users/lgladiseva/annotation_course/scripts/maker_quality_filter.pl -s ${gff}.renamed.iprscan.gff > ${gff}_iprscan_quality_filtered.gff
